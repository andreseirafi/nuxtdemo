<template>
  <div>
    ...
    <template v-else>
      ...
      <nuxt-link to="/stops/2">Jump to Stop 2</nuxt-link><br/><br/>
      <nuxt-link to="/stops/3">Jump to Stop 3</nuxt-link><br/><br/>
...
export default {
  ...
  computed: {
    stops() {
      if (this.fg_content.content_loaded) {
        return this.fg_content.stops[2];
      }
      else return false;
    }
  },
